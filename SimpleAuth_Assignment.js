...
app.get("/authenticate/", (req, res)=> {
    ...
    user.signedIn = true
    res.status(201).json({message: "Sign In sucessful",User: user})
})
//Changing password (PATCH)
...
app.delete("/authenticate/", (req, res)=> {
    ...
    res.status(204).json({message:"Account deleted sucessfully"})
})
